...
<?php if (!empty($terms[0]) || !empty($terms[1]) || !empty($terms[2])) : ?>
    <div class="advanced-search professional-development-search box">
        <h2 class="callout">Professional Development Search Tool</h2>

        <form action="<?php echo get_permalink(PAGE_PROF_DEV_SEARCH_RESULTS); ?>" method="post">
