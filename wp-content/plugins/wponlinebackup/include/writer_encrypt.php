...
class WPOnlineBackup_Writer_Encrypt
{
	...
	/*public*/ function Open( & $disk, $cipher_spec, $key, $extra = 0, $rjct_intention = false )
	{
...
HEADER;
		...
		$fields = array(
			...
			array( 'v',	3			), // OBFW_Backup_Writer_Encryption version
			// 1 is original
			// 2 fixed broken PBKDF2 in PHP < 5.2
			// 3 made AES standardised properly
			array( 'v',	0			), // Reserved
